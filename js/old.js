...
const divSobre       = document.querySelector('#divSobreMim');
...
const btnSobre       = document.querySelector('#btnSobreMim');
...
btnSobre.addEventListener('click', (e)=>{
    divSobre.classList.remove('d-none')  
    divSobre.classList.add('d-flex')
    divSobre.classList.add('fadeIn')
